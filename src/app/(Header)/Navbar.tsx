...
function Navbar() {
    ...
    return (
        <nav className="sm:flex hidden w-full md:fixed pt-6 pb-5 justify-between items-center z-10 backdrop-filter backdrop-blur-lg bg-opacity-40 border-b border-gray-600">
